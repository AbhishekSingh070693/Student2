...
* [User Creation](#2-user-creation)
* [Tomcat Installation & Configuration](#3-tomcat-installation--configuration)
* [Jenkins Installation & Configuration](#4-jenkins-installation--configuration)
* [System Fixes](#5-system-fixes)
* [Jenkins Plugin Installation](#6-jenkins-plugin-installation)
* [Jenkins Tools Configuration](#7-jenkins-tools-configuration)
* [Credentials Setup](#8-credentials-setup)
* [Pipeline Creation](#9-pipeline-creation)
* [Troubleshooting & Fixes](#10-troubleshooting--fixes)
* [Successful Deployment](#11-successful-deployment)
...
#### EC2 Setup - Security Group Rules
![EC2-Setup-3](EC2-Setup-3.png)
...
wget [https://dlcdn.apache.org/tomcat/tomcat-9/v9.0.119/bin/apache-tomcat-9.0.119.tar.gz](https://dlcdn.apache.org/tomcat/tomcat-9/v9.0.119/bin/apache-tomcat-9.0.119.tar.gz)
...
```xml
<Connector connectionTimeout="20000" maxParameterCount="1000" port="9090" protocol="HTTP/1.1" redirectPort="8443"/>
...
```xml
<!--  <Valve allow="127\.0\.0\.1|::1" className="org.apache.catalina.valves.RemoteAddrValve"/>-->
            ...
            steps {
                checkout scmGit(
                    ...
                    userRemoteConfigs: [[
                        ...
                        url: '[https://github.com/AbhishekSingh070693/Student2.git](https://github.com/AbhishekSingh070693/Student2.git)'
                    ]]
                )
            }
        }
...
*(No separate file reference needed)*
...
1. ✅ **Checkout** - Code pulled from GitHub (0.61s)
2. ✅ **Test** - Echo test passed (59ms)
3. ✅ **Build** - Maven build completed (7s)
4. ✅ **Deploy** - WAR deployed to Tomcat (3s)
